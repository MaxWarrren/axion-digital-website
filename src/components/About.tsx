export default function About() {
  return (
    <section id="about" className="max-w-[1400px] mx-auto px-5 md:px-16 py-16 md:py-24">
      <div className="flex flex-col md:flex-row items-start md:items-center gap-10 md:gap-20">
        ...
        <div className="w-full md:flex-1 flex flex-col gap-5">
          ...
          <h2 className="text-[26px] md:text-[34px] font-light leading-[1.15] tracking-[-0.02em] text-white max-w-[500px]">
            University-backed AI consulting, built from the frontier.
          </h2>
          <p className="text-[14px] md:text-[15px] font-light leading-[1.75] max-w-[480px]" style={{ color: 'rgba(255,255,255,0.35)' }}>
        ...
        <div className="w-full md:flex-[0_0_42%]">
          <img
